<template>
      ...
      <section class="bg-[#210863] py-16 pb-64 md:pt-16 sm:pt-10 pt-5">
        <div class="lg:container sm:mx-auto mx-5">
          ...
          <p class="text-center text-white sm:text-xl text-sm pt-10 pb-5">
            Elevate Your Brand with Professional, Secure, and Reliable Email Hosting
          </p>
        </div>
      </section>
              ...
              <div class="grid grid-cols-12 lg:gap-10 gap-5 flex">
                ...
                >
                  <div>
                    ...
                    >
                        Whether for personal or business use our email hosting makes it easy to have your very own personalised email addres with powerful features.
                    </p>
                ...
                <div class="lg:col-span-6 col-span-12">
                  <div class="text-left pb-6 flex lg:block justify-center">
                    <div>
                      ...
                      <p class="font-light Mulish-light pt-1">
                        Give your email a professional look with <br class="sm:flex hidden" />
                  ...
                  <div class="text-left pb-6 lg:block flex justify-center">
                    <div>
                      ...
                      <p class="font-light Mulish-light pt-1">
                        premium filtering to keep your inbox <br class="sm:flex hidden" />
                  ...
                  <div class="text-left pb-6 lg:block flex justify-center">
                    <div>
                      ...
                      <p class="font-light Mulish-light pt-1">
                        email archiving and recovery and <br class="sm:flex hidden" />
                        never lose an email again, emails are <br class="sm:flex hidden" />
                  ...
                  <div class="text-left pb-6 lg:block flex justify-center">
                    <div>
                      ...
                      <p class="font-light Mulish-light pt-1">
                        Our team is always on hand to provide <br class="sm:flex hidden" />
                        personalized support, ensuring your <br class="sm:flex hidden" />
                        email hosting needs are met quickly <br class="sm:flex hidden" />
                        and effectively.
                      </p>
                    </div>
                  </div>
          ...
          >
            ...
            <div class="col-span-2">
              ...
              >
                ...
                <div class="px-5 text-center text-[#0F132A] pb-8">
                  <p class="text-center sm:text-xl text-sm py-5">BUSINESS STARTUP</p>
                  <p class="text-center sm:text-base text-sm pb-5">
                    Get your professional powerful, reliable  email @your domain without changing your hosting plan!
                  </p>
                  ...
                  <div class="pt-6 pb-16">
                    <p class="mb-3">
                      <strong class="Mulish-Black">Disk Space per Mail Box</strong>: 10GB
                    </p>
                    <p class="mb-3">
                      <strong class="Mulish-Black">Email</strong> @ <strong class="Mulish-Black">your domain</strong>
                    </p>
                    <p class="mb-3">
                    ...
                    <p class="mb-3">
                      <strong class="Mulish-Black">Unlimited</strong> email aliases
                    </p>
                    <p class="mb-3">
            ...
            <div class="col-span-2">
              ...
              >
                ...
                <div class="px-5 text-center text-[#0F132A] pb-8">
                  <p class="text-center sm:text-xl text-sm py-5">BUSINESS CORPORATE</p>
                  <p class="text-center sm:text-base text-sm pb-5">
                    Get your professional powerful, reliable  email @your domain without changing your hosting plan!
                  </p>
                  <p class="text-base font-black pb-3">Starting at</p>
                  ...
                  <div class="pt-6 pb-16">
                    <p class="mb-3">
                      <strong class="Mulish-Black">Disk Space per Mail Box</strong>: 25GB
                    </p>
                    <p class="mb-3">
                      <strong class="Mulish-Black">Email</strong> @ <strong class="Mulish-Black">your domain</strong>
                    </p>
    ...
    <section class="pb-12 bg-[#210863] relative">
            ...
            <div>
              ...
              <div class="text-left">
                ...
                <p class="font-light pt-1 max-w-[250px] text-[#fff]">
                    Create your signature using html or plain text, and update your display name or the name of your organization.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div>
              ...
              <div class="text-left">
                ...
                <p class="font-light pt-1 max-w-[250px] text-[#fff]">
                    Search your mailbox and narrow down the results using intuitive filters.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div>
              ...
              <div class="text-left">
                ...
                <p class="font-light pt-1 max-w-[250px] text-[#fff]">
                    Get everything you expect from a modern compose feature with a great selection of formatting options, drag and drop images, add links and check spelling in 44 languages.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div>
              ...
              <div class="text-left">
                ...
                <p class="font-light pt-1 max-w-[250px] text-[#fff]">
                    Access a complete directory of your contacts, add personal details and notes to keep information up to date and handy.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div>
              ...
              <div class="text-left">
                ...
                <p class="font-light pt-1 max-w-[250px] text-[#fff]">
                    Access your email through the native email app on your Android or iPhone device using a POP or IMAP connection.
                </p>
              </div>
            </div>
          </div>
    ...
    <section class="lg:pb-16 pb-10 block mt-16">
      <div
