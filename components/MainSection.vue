    ...
    <div class="container mx-auto">
      <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12 lg:col-span-6">
          <h2
            class="leading-tight sm:text-4xl md:lg:text-5xl md:text-4xl sm:text-[36px] text-[25px] lg:text-left text-center text-[36px] font-bold lg:py-32 pt-0 sm:pb-16 pb-5"
          >
            New Web Hosting, <br class="sm:flex hidden" />
            New Potential
          </h2>
          <p
            class="sm:text-xl text-sm lg:text-left text-center sm:pt-8 sm:px-0 px-3"
          >
          ...
          <div>
            ...
            <div class="text-left">
              ...
              <p class="font-light pt-1 max-w-[250px]">
                ...
                availability, you can trust that your website will always be up
                and running smoothly and remain accessible to your audience.
              </p>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div class="text-left">
              ...
              <p class="font-light pt-1 max-w-[250px]">
                ...
                Our team of professionals is ready to assist with all your needs
                at any time.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="text-left">
              ...
              <p class="font-light pt-1 max-w-[250px]">
                ...
                website loading times as our servers will never overload.
              </p>
            </div>
          </div>
        </div>
...
const getResultFromWhois = async (name: string) => {
  const apiKey = '3c23da2619baa5b883e5c98e717c61104c64025919a058304b0e55f2587ec3ec8883231e21eb85ef7a94dc5fcd53aac4a9a0ad2b6ac3e250'
  const xml = `
  ...
  const { data, refresh, error } = useFetch("/api/whois/", {
    ...
    headers: {
      ...
      "X-Username": "host2media",
      "X-Signature": md5(md5(xmlDoc + apiKey).toString()+apiKey).toString(),
    },
    immediate: false,
  });
  await refresh();
  console.log(xmlDoc + apiKey)
  console.log(md5(xml + apiKey).toString()+apiKey);
  console.log(md5(xml + apiKey).toString());
  console.log(md5(md5(xml + apiKey).toString()+apiKey).toString());
  if (error.value) {
